...
function AutomataNewParticle(x,y,particle,circle){
  //console.log(particle)
            let neighbors = convolutionCircleT(x,y,content[particle].S,particle)
            if (neighbors[1]>=0.4 && neighbors[0] >= 0.33 && neighbors[0] <= 0.86) {
            
              next[x][y][particle] = neighbors[0] - grid[x][y][particle] 
            ...
            } else if (neighbors[1]<0.4 && neighbors[0] >= 0.27 && neighbors[0] <= 0.36) {
